...
const socialLinks = [
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/company/rivendell-tech',
    icon: (
  ...
  {
    name: 'GitHub',
    url: 'https://github.com/rivendell-tech',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Spotify',
    url: 'https://open.spotify.com/show/2uo4tPdW29rqB9Shhd8hcK',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'TradingView',
    url: 'https://www.tradingview.com/u/rivendell-tech',
